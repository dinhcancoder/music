let listSong = [
  ...
  },
  {
    ...
    avatar: "yeumotnguoicouocmo.jpg",
    author: "Bùi Trường Linh",
    singer: "Bùi Trường Linh - 06/11/2022",
    like: "625K người yêu thích",
    time: "04:46",
    source: "yeumotnguoicouocmo.mp3",
    tym: "1.2M",
    listen: "25.6M",
  },
];
...
let dialogImageBack = document.querySelector(
  ".playerBack .player-dialogImage img"
);
let dialogNameBack = document.querySelector(".playerBack .player-dialogName");
let dialogAuthorBack = document.querySelector(
  ".playerBack .player-dialogAuthor"
);

dialogImage.setAttribute(
  "src",
  `./assets/image/${
    listSong[indexSong == listSong.length - 1 ? 0 : indexSong + 1].avatar
  }`
);
dialogName.textContent =
  listSong[indexSong == listSong.length - 1 ? 0 : indexSong + 1].title;
dialogAuthor.textContent =
  listSong[indexSong == listSong.length - 1 ? 0 : indexSong + 1].author;

dialogImageBack.setAttribute(
  "src",
  `./assets/image/${
    listSong[indexSong == 0 ? listSong.length - 1 : indexSong - 1].avatar
  }`
);
dialogNameBack.textContent =
  listSong[indexSong == 0 ? listSong.length - 1 : indexSong - 1].title;
dialogAuthorBack.textContent =
  listSong[indexSong == 0 ? listSong.length - 1 : indexSong - 1].author;

function displayInfo(indexSong) {
  musicAvatar.setAttribute(
    "src",
    `./assets/image/${listSong[indexSong].avatar}`
  );
